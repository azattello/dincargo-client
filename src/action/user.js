...
export const registration = (name, surname, phone, password) => {
    return async dispatch => {
        try {
            ...
            const registrationResponse = await axios.post('https://din-cargo.kz:3001/api/auth/registration', {
                name,
                surname,
                phone,
                password
            ...
            const loginResponse = await axios.post('https://din-cargo.kz:3001/api/auth/login', {
                phone,
                password
            });
...
export const login =  (phone, password) => {
    return async dispatch => {
        try {
            const response = await axios.post(`https://din-cargo.kz:3001/api/auth/login`, {
                phone,
                password
            })
...
export const auth = () => {
    return async dispatch => {
        try {
            ...
            const response = await axios.get(`https://din-cargo.kz:3001/api/auth/auth`, {
